...
| RSVPs    | POST   | /v1/rsvps | Bearer rsvp:write | body: examples/rsvp_create.json | 201 item | 400,401,403,409,422,429,5xx | error_v1 | n/a | Idempotency-Key; reuse 201 body (1h) | /v1 | UC: capacity→409; tests: S9/tests/postman_collection.json |
